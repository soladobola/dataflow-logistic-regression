 ...
 * \param [in] instream_example The stream should be of size ((param_N * 2) * 4) bytes.
 * \param [in] instream_theta The stream should be of size ((param_N * 2) * 4) bytes.
 * \param [in] instream_y The stream should be of size (param_N * 4) bytes.
 * \param [out] outstream_result The stream should be of size ((param_N * 2) * 4) bytes.
 */
void Vectors(
	int32_t param_N,
...
typedef struct { 
	...
	const float *instream_example; /**<  [in] The stream should be of size ((param_N * 2) * 4) bytes. */
	const float *instream_theta; /**<  [in] The stream should be of size ((param_N * 2) * 4) bytes. */
	const float *instream_y; /**<  [in] The stream should be of size (param_N * 4) bytes. */
	float *outstream_result; /**<  [out] The stream should be of size ((param_N * 2) * 4) bytes. */
} Vectors_actions_t;
